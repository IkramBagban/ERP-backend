                ...
                <div className="pageheader pd-t-15 pd-b-10">
                    <div className="d-flex justify-content-between">
                        ...
                        <div className="d-flex align-items-center d-print-none">
                            <Link className="btn btn-primary rounded-pill pd-t-6-force pd-b-5-force mg-r-3" title={lang.profile_picture} href="/users/profile-picture"><i className="fal fa-image"></i></Link>
                        </div>
                    </div>
                </div>
                {/* Breadcrumb End */}
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-6 mt-3">
                                        <div className="form-group">
                                            ...
                                            <input type="text" className="form-control bd-info" id="user_name" name="user_name" value={user_name} onChange={(e) => setUser_name(e.target.value)} required />
                                        </div>
                                    </div>
                                </div>
                                <div className="row">
                                    ...
                                    <div className="col-md-6 mt-3">
                                        <div className="form-group">
                                            ...
                                            <input type="text" className="form-control bd-info" id="user_designation" name="user_designation" value={user_designation} onChange={(e) => setUser_designation(e.target.value)} required />
                                        </div>
                                    </div>
                                </div>
                                <div className="row">
                                    <div className="col-md-6 mt-3">
                                        <div className="form-group">
                                            ...
                                            <input type="text" className="form-control bd-info" id="user_phone" name="user_phone" value={user_phone} onChange={(e) => setUser_phone(e.target.value)} required />
                                        </div>
                                    </div>
                                    <div className="col-md-6 mt-3">
                                        <div className="form-group">
                                            <label className="form-label tx-semibold" htmlFor="user_email">{lang.email}</label>
                                            <input type="text" className="form-control bd-info" id="user_email" name="user_email" value={user_email} onChange={(e) => setUser_email(e.target.value)} required />
                                        </div>
                                    </div>
                                </div>
                                <div className="row">
                                    <div className="col-md-12 mt-3">
                                        <div className="form-group">
                                            ...
                                            <input type="text" className="form-control bd-info" id="user_address" name="user_address" value={user_address} onChange={(e) => setUser_address(e.target.value)} required />
                                        </div>
                                    </div>
                                </div>
                                <div className="row">
